...
function App() {
  ...
  return (
    <div>
      <div className={styles.container}>Welcome to the Decentralized ToDo App</div>
          ...
          <tbody>
            {tasks.map((task, index) => (
              <tr key={index}>
                ...
                <td>
                  {task.status === 0 ? <button className={styles.button} onClick={() => changeTaskStatus(index)}>Mark as complete</button> : null}
                </td>
              </tr>
            ))}
          </tbody>
